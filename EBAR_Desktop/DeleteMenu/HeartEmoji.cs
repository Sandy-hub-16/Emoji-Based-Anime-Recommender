...
namespace EBAR_Desktop.DeleteMenu
{
    public partial class HeartEmoji : Form
    {
        ...
        private void btnRemove_Click(object sender, EventArgs e)
        {
            ...
            {
                eBARProcess.RemoveAnimeBasedOnEmoji("HEART", animeInput);
                MessageBox.Show($"Anime : {animeInput} has been removed from ❤️ Emoji List.");
                txtInput.Clear();
            ...
            {
                MessageBox.Show($"Anime : {animeInput} does not exist in ❤️ Emoji List.");
            }
        }
